...
var _fetchHelper = __webpack_require__(8);
...
var Markup = exports.Markup = function Markup(props, children) {
    var html = children ? _prismjs2.default.highlight(children[0], _prismjs2.default.languages.jsx) : '';
...
var _promiseQueue = __webpack_require__(10);
...
var _reduxy = __webpack_require__(29);
...
var _streamyHyperscript = __webpack_require__(12);
...
function makeChildrenStreams$(children) {
	...
	var children$Arr = childrenArr.map(function (child) {
...
var _clicks = __webpack_require__(4);

var _demo_component = __webpack_require__(20);

__webpack_require__(49);

var _subheader = __webpack_require__(5);
...
function Examples(_ref) {
    ...
    var activeExample$ = (0, _src.stream)(0);
    var exampleSection = (0, _src.h)(
        'div',
        { 'class': 'section' },
        [(0, _src.h)(
            _subheader.Subheader,
            { title: 'Examples', subtitle: 'Play around with it. See the reactive changes.' },
            []
        ), (0, _src.h)(
            'div',
            { 'class': 'row' },
            [(0, _src.h)(
                ...
                [(0, _src.h)(
                    ...
                    [(0, _src.h)(
                        Example,
                        { exampleId: 0, title: 'Render a simple sub component', activeExample$: activeExample$ },
                        [(0, _src.h)(
                            _utils.Markup,
                            null,
                        ...
                        Example,
                        { exampleId: 1, title: 'Manipulate the state/store and display the data', activeExample$: activeExample$ },
                        [(0, _src.h)(
                            _utils.Markup,
                            null,
                            ...
                            [(0, _src.h)(
                                'button',
                                { 'class': 'btn waves-effect waves-light highlight highlight-background', onclick: function onclick(e) {
                                        return store.dispatch({ type: _clicks.CLICK });
                                    } },
                                ['+1']
                            ), (0, _src.h)(
                                'button',
                                ...
                                'p',
                                null,
                                ['Counter: ', store.$('clicks.clicks')]
                            )]
                        )]
                    ), (0, _src.h)(
                        Example,
                        { exampleId: 2, title: 'Properties can be streams as well', activeExample$: activeExample$ },
                        [(0, _src.h)(
                            _utils.Markup,
                            null,
                            ...
                            [(0, _src.h)(
                                'p',
                                { 'class': store.$('clicks.clicks').map(function (clicks) {
                        ...
                        Example,
                        { exampleId: 4, title: 'Components can have a nested state', activeExample$: activeExample$ },
                        [(0, _src.h)(
                            _utils.Markup,
                            null,
                        ...
                        Example,
                        { exampleId: 5, title: 'Components can manipulate any stream (or redux store) given to them', activeExample$: activeExample$ },
                        [(0, _src.h)(
                            _utils.Markup,
                            null,
                        ...
                        Example,
                        { exampleId: 6, title: 'ZLIQ provides a basic router', activeExample$: activeExample$ },
                        [(0, _src.h)(
                            _utils.Markup,
                            null,
                            ...
                            [(0, _src.h)(
                                'a',
                                { 'class': 'btn highlight highlight-background', href: '/?foo=bar' },
                                ['Go to \'/?foo=bar\'']
                            ), (0, _src.h)(
                                'p',
                                null,
                                ['You are currently at route \'', store.$('router.route'), '\' with params \'', store.$('router.params').map(function (params) {
                                    return JSON.stringify(params);
                                }), '\'.']
                            ), (0, _src.h)(
                                _src.Router,
                                { store: store, route: '/subroute' },
                                ['This will not be visible.']
                            )]
                        )]
                    )]
...
function Example(_ref2, children) {
    var exampleId = _ref2.exampleId,
        title = _ref2.title,
        activeExample$ = _ref2.activeExample$;
    ...
    return (0, _src.h)(
        ...
        [(0, _src.h)(
            'div',
            {
                className: activeExample$.map(function (active) {
                    return 'collapsible-header ' + (active === exampleId ? 'active' : '');
                }),
                onclick: function onclick() {
                    return activeExample$(exampleId);
                }
            },
            [title]
        ), (0, _src.h)(
            ...
            [(0, _src.h)(
                ...
                [(0, _src.h)(
                    ...
                    [(0, _src.h)(
                        ...
                        "p",
                        { "class": "light center" },
                        ["ZLIQ uses streams to apply changes to the DOM. You can provide these streams per component. Or you can use the provided Redux implementation, for a centralised state management.", (0, _src.h)(
                            "br",
                            null,
                            []
                        ), "Feel the flow."]
                ...
                [(0, _src.h)(
                    ...
                    [(0, _src.h)(
                        ...
                        "p",
                        { "class": "light center" },
                        ["ZLIQ has only a few lines of code (~680 April 2017 incl. comments). ZLIQ will be the first framework you actually understand E2E.", (0, _src.h)(
                            "br",
                            null,
                            []
                        ), "Own your code."]
...
var Playground = exports.Playground = function Playground() {
    return (0, _src.h)(
        ...
        [(0, _src.h)(
            _subheader.Subheader,
            { title: 'Experiment', subtitle: 'Get your hands dirty' },
            []
        ), (0, _src.h)(
            'script',
...
var Tutorial = exports.Tutorial = function Tutorial() {
        return (0, _src.h)(
                ...
                [(0, _src.h)(
                        _subheader.Subheader,
                        { title: 'Writing Components', subtitle: 'Hello World here we come' },
                        []
                ), (0, _src.h)(
                        'p',
                        null,
                        ...
                        ['States across multiple components and along multiple server requests gets unpredictable. As a developer in these situations you catch yourself not knowing where to debug now. ZLIQ include a very lite ', (0, _src.h)(
                                ...
                                ['Redux']
                        ), ' implementation to enable centralised state management. (If you don\'t know Redux please read up on it.)']
                ), (0, _src.h)(
                        'p',
                        null,
...
var DumbComponent = exports.DumbComponent = function DumbComponent(_ref2) {
	...
	return (0, _utils.h)(
		...
		[(0, _utils.h)(
			'button',
			{ 'class': 'btn waves-effect waves-light highlight highlight-background', onclick: function onclick() {
					return store.dispatch({ type: _clicks.SUBTRACKED });
				} },
			['-1']
		)]
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(7), __webpack_require__(26)))
...
var _infos = __webpack_require__(15);

var _header = __webpack_require__(14);

var _example = __webpack_require__(13);

var _tutorial = __webpack_require__(17);

var _playground = __webpack_require__(16);
...
// core
var store = (0, _src.reduxy)({
	clicks: _clicks.clicks,
	router: _src.routerReducer
});
				...
				[(0, _src.h)(
					...
					[(0, _src.h)(
						...
						['Modern web frameworks got really big (React + Redux 139Kb and Angular 2 + Rx 766Kb, ', (0, _src.h)(
							...
							['src']
						), '). As a developer I came into the (un)pleasent situation to teach people how these work. But I couldn\'t really say, as I haven\'t actually understood each line of code in these beasts. But not only that, they also have a lot of structures I as a developer have to learn to get where I want to go. It feels like learning programming again just to be able to render some data.']
					), (0, _src.h)(
						'p',
						null,
						['ZLIQ tries to be something simple. Something that reads in an evening. But that is still so powerfull you can just go and display complex UIs with it. Something that feels more JS less Java.']
					)]
				)]
			), (0, _src.h)(
				_tutorial.Tutorial,
