...
var _fetchHelper = __webpack_require__(7);
...
var _streamy = __webpack_require__(2);

var _streamyDom = __webpack_require__(10);
...
var _promiseQueue = __webpack_require__(9);
...
var _reduxy = __webpack_require__(24);
...
var _streamyHyperscript = __webpack_require__(4);
...
var _clicks = __webpack_require__(3);

var _demo_component = __webpack_require__(15);
    ...
    var exampleSection = (0, _src.h)(
        ...
        [(0, _src.h)(
            ...
            [(0, _src.h)(
                ...
                ['Play around with it. See the reactive changes.']
            )]
        ), (0, _src.h)(
            'div',
            { 'class': 'row' },
            [(0, _src.h)(
                ...
                [(0, _src.h)(
                    ...
                    [(0, _src.h)(
                        ...
                        Example,
                        { exampleId: 3, title: 'Fetching data from a remote source is a breeze', activeExample$: activeExample$ },
                        [Markup('\n                                    <button onclick={e => fetchStuff(store)}>Fetch Quote</button>\n                                    {\n                                        store\n                                            .$([\'clicks.fetched_loading\', \'clicks.fetched_error\', \'clicks.fetched\'])\n                                            .map(([fetched_loading, fetched_error, fetched]) => {\n                                                if (fetched_loading) {\n                                                    return \'Loading ...\';\n                                                }\n                                                if (fetched_error != null) {\n                                                    return <p>An error occurred: {fetched_error}</p>;\n                                                }\n                                                if (fetched != null) {\n                                                    return <p>Fetched quote: {JSON.stringify(fetched)}</p>;\n                                                }\n                                            })\n                                    }\n                                '), (0, _src.h)(
                            ...
                            [(0, _src.h)(
                                'button',
                                { 'class': 'btn waves-effect waves-light highlight highlight-background', onclick: function onclick(e) {
                                        return fetchStuff(store);
                                    } },
                                ['Fetch Quote']
                            ), store.$(['clicks.fetched_loading', 'clicks.fetched_error', 'clicks.fetched']).map(function (_ref2) {
                                var _ref3 = _slicedToArray(_ref2, 3),
                                    fetched_loading = _ref3[0],
                                    fetched_error = _ref3[1],
                                    fetched = _ref3[2];
                                ...
                                if (fetched_error != null) {
                                    return (0, _src.h)(
                                        'p',
                                        null,
                                        ['An error occurred: ', fetched_error]
                                    );
                                }
                                if (fetched != null) {
                                    return (0, _src.h)(
                                        'p',
                                        null,
                                        ['Fetched quote: ', JSON.stringify(fetched)]
                                    );
                                }
                            })]
                        )]
...
function Example(_ref4, children) {
    var exampleId = _ref4.exampleId,
        title = _ref4.title,
        activeExample$ = _ref4.activeExample$;
            ...
            [(0, _streamyHyperscript.h)(
                ...
                [(0, _streamyHyperscript.h)(
                    ...
                    [(0, _streamyHyperscript.h)(
                        ...
                        'p',
                        { 'class': 'light center' },
                        ['ZLIQ is mainly based on functions and streams. If you know React you already understand it. But it doesn\'t force you into how to build your components.', (0, _streamyHyperscript.h)(
                            'br',
                            null,
                            []
                ...
                [(0, _streamyHyperscript.h)(
                    ...
                    [(0, _streamyHyperscript.h)(
                        ...
                        'p',
                        { 'class': 'light center' },
                        ['ZLIQ uses streams to apply changes to the DOM. You can provide these streams per component. Or you can use the provided Redux implementation, for a centralised state management.', (0, _streamyHyperscript.h)(
                            'br',
                            null,
                            []
                        ), 'Feel the flow.']
                ...
                [(0, _streamyHyperscript.h)(
                    ...
                    [(0, _streamyHyperscript.h)(
                        ...
                        'p',
                        { 'class': 'light center' },
                        ['ZLIQ has only a few lines of code (~680 April 2017 incl. comments). ZLIQ will be the first framework you actually understand E2E.', (0, _streamyHyperscript.h)(
                            'br',
                            null,
                            []
                        ), 'Own your code.']
...
var _infos = __webpack_require__(12);
