...
var SuperDumbComponent = exports.SuperDumbComponent = (0, _streamyHyperscript.h)(
	'p',
	null,
	['HELLO WORLD']
);
...
describe('CleverComponent', function () {
	it('should show clicks', function () {
		...
		var store = (0, _mockStore.mockStore)({ clicks: { clicks: 5 } });
		var component$ = (0, _demo_component.CleverComponent)({ sinks: { store: store } });
		// then we render the result of the hyperscript stream and check the dom result
		var elem = (0, _virtualDom.create)(component$(), null);
		(0, _chai.expect)(elem.innerText).to.contain('5');
	});
});
...
var __webpackManifest__ = ['../src/reducers/clicks', '../src/utils/streamy', '../src/demo_component.jsx', './array-utils', '../utils/fetch-helper', './utils/streamy-hyperscript', './demo_component.spec.js', './mockStore', './demo_component.scss', './dabd1cb11e4497d8e8b5cb8306007354-entry.js'];
