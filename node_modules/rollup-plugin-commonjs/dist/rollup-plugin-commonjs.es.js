...
function transformCommonjs ( code, id, isEntry, ignoreGlobal, customNamedExports, sourceMap ) {
	...
	return {
		...
		transform: function transform ( code, id ) {
			...
			return entryModuleIdPromise.then( function () {
				var transformed = transformCommonjs( code, id, id === entryModuleId, ignoreGlobal, customNamedExports[ id ], sourceMap );
